...
def test_job_posting_creation():
    ...
    assert job_posting.jobPosition == "Software Engineer"
    assert job_posting.user == user
    assert job_posting.full_name() == "John Doe"
    assert str(job_posting) == "Software Engineer"
