...
const ProfileEditAlumni = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post("http://localhost:8008/profile/profile-edit-alumni/", profileData);
    ...
    return (
        <div className="profile-form">
            <form className="profile-editing" onSubmit={handleSubmit}>
                ...
                <label htmlFor="gradTerm">Graduation Term <div className="required-fields">*</div> </label>
                <select
                    id="gradTerm"
                ...
                {skills.map((skill, index) => (
                    <div key={index} className="skills-section">
                        <label htmlFor={`skillName-${index}`}>Skill Name <div className="required-fields">*</div></label>
                        <input
                            type="text"
                            id={`skillName-${index}`}
                            name="skillName"
